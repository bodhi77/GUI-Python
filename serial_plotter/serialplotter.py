...
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg, NavigationToolbar2Tk  # matplotlib backend
...
parser.add_argument('-p','--port_name', default='/dev/ttyACM0', help='The name of the serial port, default=COM3')
parser.add_argument('-b','--baud_rate', default=15200, help ='Baud rate, default=9600', type=int)
